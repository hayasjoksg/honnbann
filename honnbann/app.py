...
from flask import render_template, request, redirect #リダイレクトから
from flask_login import UserMixin, LoginManager
from werkzeug.security import generate_password_hash#ここまで
...
@app.route('/signup', methods=['GET', 'POST'])#サインアップ
def signup():
